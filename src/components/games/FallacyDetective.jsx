...
export default function FallacyDetective({ onFinish, playSound, muted, toggleMute, mode }) {
  ...
  const currentData = mode === 'business' ? fallaciesBusiness : fallaciesDaily;
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginBottom: '24px' }}>
              ...
              <div style={{ padding: '16px', borderRadius: '12px', background: 'rgba(255, 255, 255, 0.02)', border: '1px solid var(--border-color)' }}>
                ...
                <ul style={{ fontSize: '13px', color: 'var(--text-secondary)', marginTop: '6px', paddingLeft: '16px', lineHeight: '1.6' }}>
                  <li><strong>ストローマン論法</strong>: {mode === 'business' ? '「食堂の野菜メニューを増やそう」➡「肉食を完全に禁止するのか」と歪める。' : '「少し野菜も食べよう」➡「今日からサラダしか食べるなと言うのか」と歪める。'}</li>
            ...
            {isAnswered && (
              <div 
                ...
                style={{ 
                  ...
                  border: `1px solid ${currentQuestion.choices[selectedChoiceIdx].isCorrect ? 'rgba(16, 185, 129, 0.2)' : 'rgba(244, 63, 94, 0.2)'}`,
                  marginBottom: '24px'
                }}
              >
